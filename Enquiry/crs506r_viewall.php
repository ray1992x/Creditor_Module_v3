...
<?php
	...
	if ($conn->connect_error){
		die("connection failed:" . $conn->connect_error);
			...
			$sql = "SELECT BatchNumber,BatchType,BatchDate,BatchPeriod,BatchTotal,CheckTotal,Difference,TransactionCount FROM batchheader ORDER BY BatchType";//select database
