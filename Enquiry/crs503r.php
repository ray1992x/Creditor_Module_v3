...
*/
	...
	if(isset($_POST['View2'])){
		if ($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			$windowname = "crs503r_viewall.php";
...
<legend><strong>Purchase Order Master Listing</strong></legend>
	...
	<td><label><a href="../Enquiry.php"><button class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></button></a></label>
			<label><a href="crs503r.php"><button class="btn btn-default"><span class="glyphicon glyphicon-refresh"></span> Refresh</button></a></label></td>
	</table>
	<table>
		<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input onclick="radioCRCode()" type="radio" name="PO_PrintOp" id="PO_PrintOp" value="ByCreditor" <?php if ($PO_PrintOp=='ByCreditor') { echo 'checked'; } ?> />By Creditor Code</label>
				<label><input disabled type="text" name="CR_Code" id="CR_Code" /></label><font color="red"><?php echo $POMLerr1 ;?></font>
				<br><br>
				<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input onclick="radioPODate()" type="radio" name="PO_PrintOp" id="PO_PrintOp" value="ByPOD" <?php if ($PO_PrintOp=='ByPOD') { echo 'checked'; } ?> />By Purchase Order Date</label>
				<br>
				<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from&nbsp;<input disabled type="text" name="PO_From" id="PO_From" /> To <input disabled type="text" name="PO_To" id="PO_To" /></label><font color="red"><?php echo $POMLerr2 ;?></font>
				</td>
