    ...
    <legend><strong>Creditor Transaction Enquiry</strong></legend>
		...
		<table>
			<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				...
				<tr>
					<td>From Date</td>
					<td><input id="date" type="text" size="10" name="From_Date" class="form-control txt-auto"/></td>
					<td></td>
					<td></td>
				</tr>
				<tr>
					<td>To Date</td>
					<td><input id="Tdate" type="text" size="10" name="To_Date" class="form-control txt-auto" /></td>
				</tr>
				<tr>
					<td style="vertical-align:top">Print</td>
					<td>
					<p>
					<label><input type="radio" name="Trans_Type" id="Trans_Type" value="Invoice"/>Invoice</label><br>
					<label><input type="radio" name="Trans_Type" id="Trans_Type" value="Payment" />Payment</label><br>
					<label><input type="radio" name="Trans_Type" id="Trans_Type" value="CreditNote"/>Credit Note</label><br>
				...
				<td><button name="Find"  value="View Enquiry"class="btn btn-default"/><span class="glyphicon glyphicon-eye-open"> View</button></td></tr>
			</form> 
		</table>
