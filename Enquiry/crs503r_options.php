	...
	<table>
		<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<tr>
				...
				<td><label><input onclick="radioCRCode()" type="radio" name="PO_PrintOp" id="PO_PrintOp" value="ByCreditor" <?php if ($_SESSION['PO_PrintOp']=='ByCreditor') { echo 'checked'; } ?> />By Creditor Code</label><br>
				<label><input class="form-control txt-auto" <?php if(empty($_SESSION['CR_Code'])) { echo 'disabled';} else { echo 'value="'.$_SESSION['CR_Code'].'"'; } ?> type="text" name="CR_Code" id="CR_Code" /></label><font color="red"><?php echo $POMLerr1 ;?></font>
				<br><br>
				...
				<br>
				<label>from date:<br><input class="form-control txt-auto" <?php if(empty($_SESSION['PO_From'])) { echo 'disabled';} else { echo 'value="'.$_SESSION['PO_From'].'"'; } ?> type="text" name="PO_From" id="PO_From" /><br> to date: <br><input class="form-control txt-auto" <?php if(empty($_SESSION['PO_To'])) { echo 'disabled';} else { echo 'value="'.$_SESSION['PO_To'].'"'; } ?> type="text" name="PO_To" id="PO_To" /></label><font color="red"><?php echo $POMLerr2 ;?></font>
				</td>
			...
			<td><button name="View"  value="View"  class="btn btn-default" /><span class="glyphicon glyphicon-eye-open"> View</button></td>
			<td><button name="View2"  value="View2"  class="btn btn-default" /><span class="glyphicon glyphicon-eye-open"> All</button></td>
