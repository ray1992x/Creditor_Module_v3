...
<legend><strong>Creditor Batch Listing</strong></legend>
	...
	<table>
		<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<tr>
				<td style="vertical-align:top;padding-top:6px;">Batch Type<br>&nbsp;</td>
				<td>
				<label><input onclick="changeRadioButton(this)" type="radio" name="Batch_Type" id="Batch_Type" value="Invoice" />Invoice &nbsp;</label><br>
				<label><input onclick="changeRadioButton(this)" type="radio" name="Batch_Type" id="Batch_Type" value="Credit Note"/>Credit Note &nbsp;</label><br>
				<label><input onclick="changeRadioButton(this)" type="radio" name="Batch_Type" id="Batch_Type" value="Journal"/>Journal &nbsp;</label><br>
				<label><input onclick="changeRadioButton(this)" type="radio" name="Batch_Type" id="Batch_Type" value="Auto Payment"/>Auto Payment &nbsp;</label><br>
			...
			<tr>
				...
				<td><label><input class="form-control txt-auto" type="text" name="CR_Num" id="CR_Num" /></label><font color="red"><?php echo $POMLerr1;?></font></td>
			<tr>
			<table>
			<tr>
			...
			<td><button name="Print2"  value="Print2"  class="btn btn-default" /><span class="glyphicon glyphicon-eye-open"> All</button></td>
			</tr>
			</table>
