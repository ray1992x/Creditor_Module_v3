...
$query_view = "SELECT BatchNumber,BatchType,BatchDate,BatchPeriod,BatchTotal,CheckTotal,Difference,TransactionCount FROM batchheader WHERE BatchType='".$CR_BatchType."' AND BatchNumber LIKE '%".$CR_Number."%' ORDER BY BatchType";
...
<?php
	...
	if ($conn->connect_error){
		die("connection failed:" . $conn->connect_error);
			...
			$sql = $query_view;//select database
