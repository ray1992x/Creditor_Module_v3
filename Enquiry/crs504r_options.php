...
<legend><strong>Unfilled Purchase Order</strong></legend>
	...
	<table>
		<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<tr>
				<td style="vertical-align:top;padding-top:6px;">As at Date</td>
				<td>
				<label><input class="form-control txt-auto" type="text" name="UFPO_Date" id="UFPO_Date" value="<?php echo date('F d, Y'); ?>" disabled /></label>
				<br><br>
			...
			<tr>
					<td><p>First Creditor Code</p></td>
					<td><label><input class="form-control txt-auto" type="text" name="F_CR_Code" id="F_CR_Code" value="<?php echo $CR_Code_First;?>" /></label></td>
					<td><font color="red"><?php echo $CMLerr2 ;?></font></td>
				<tr>
				</tr>
					<td>Last Creditor Code</td>
					<td><label><input class="form-control txt-auto" type="text" name="L_CR_Code" id="L_CR_Code" value="<?php echo $CR_Code_Last;?>" /></label></td>
					<td><font color="red"><?php echo $CMLerr3 ;?></font></td>					
				</tr>
				<tr>
					<td>Order By</td>
					<td>
					<label><input type="radio" name="CTH_Order" id="CTH_Order" value="Code" <?php if ($CML_Order=='Code') { echo 'checked'; } ?> />Creditor Code</label><br>
				...
				<td>&nbsp;&nbsp;<button name="Print"  value="Print"  class="btn btn-default" /><span class="glyphicon glyphicon-eye-open"> View</button></td></tr>
				</table>
		</form> 
	</table>
