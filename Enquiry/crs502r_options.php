	...
	<table>
		<form id="form" name="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<tr>
				...
				<td>
				<label><input class="form-control txt-auto" disabled="disabled" type="text" name="CR_Code_First" id="CR_Code_First" value="<?php echo $CR_Code_First;?>"  /></label>
				</td>
			...
			<tr>
				...
				<td>
				<label><input class="form-control txt-auto" disabled="disabled" type="text" name="CR_Code_Last" id="CR_Code_Last" value="<?php echo $CR_Code_Last;?>"  /></label>
				</td>
