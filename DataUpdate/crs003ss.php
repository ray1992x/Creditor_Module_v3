	...
	<?php
		...
		<table>
			...
			<td height="10"></td>
				...
				<tr>
					<td> Creditor Code  </td>
					<td width="250"> <label><input type="text" disabled="disabled" pattern="[C][0-9]{3,3}" title="{C}{3-digit code} without parentheses" placeholder="Enter Creditor Code" name="CR_Code" id="CR_Code"  value="<?php echo "".$_SESSION['CurrCred'].""; ?>"></label> </td> 
