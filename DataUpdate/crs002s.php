...
<td width="250"><p><label><input disabled="disabled" type="text" placeholder="Enter Creditor Code" name="CR_Code" id="CR_Code" value="<?php echo $CR_Code;?>" ></label></p><font color="red"><?php echo "$CR_Code_Err $CMExist $CMNoExist";?></font></td>
</tr>
<tr>			
...
<td><p><label> <input disabled="disabled" type="text" placeholder="Enter Company Number" name="CompanyNo" id="CompanyNo" value="<?php echo $CompanyNo;?>" ></label></p><font color="red"><?php echo $CompanyNo_Err;?></font></td>
</tr>
<tr>
<td><p>Credit Period</p></td>
<td><p><label> <input disabled="disabled" type="text" placeholder="Enter Credit Period" name="CR_Period" id="CR_Period" value="<?php echo $CR_Period;?>" ></label></p><font color="red"><?php echo $CR_Period_Err;?></font></td>
</tr>
<tr>
<td><p>Remark</p></td>
<td><p><label> <input disabled="disabled" type="text" placeholder="Enter Remark" name="Remark" id="Remark" value="<?php echo $Remark;?>" ></label></p><font color="red"><?php echo $Remark_Err;?></font></td>
</tr>
<tr>
...
<td width="250"><p><label><input disabled="disabled" type="text" placeholder="Enter Contact Name" name="Contact_Name" id="Contact_Name" value="<?php echo $Contact_Name;?>" ></label> 
<font color="red"><?php echo $Contact_Name_Err;?></font></td>
</tr>
<tr>
<td><p>Contact Telephone 1</p></td>
<td><p><label><input disabled="disabled" type="text" placeholder="Enter Telephone" name="Tel1" id="Tel1" value="<?php echo $Tel1;?>" ></label>
<font color="red"><?php echo $Tel1_Err;?></font></td> 
<td><p>&nbsp;&nbsp;&nbsp;&nbsp;Fax Contact</td>
<td><p><label><input disabled="disabled" type="text" placeholder="Enter Fax" name="Fax" id="Fax" value="<?php echo $Fax;?>" ></label>
<font color="red"><?php echo $Fax_Err;?></font></td> 
</tr>	
<tr>
<td><p>Contact Telephone 2</p></td>
<td><p><label><input disabled="disabled" type="text" placeholder="Enter Telephone" name="Tel2" id="Tel2" value="<?php echo $Tel2;?>" ></label>
<font color="red"><?php echo $Tel2_Err;?></font></td> 
<td width="150"><p>&nbsp;&nbsp;&nbsp;&nbsp;E-mail Contact</td>
<td><p><label><input disabled="disabled" type="text" placeholder="Enter E-mail" name="Contact_Email" id="Contact_Email" value="<?php echo $Contact_Email;?>" ></label>
